...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Julio\\Downloads\\Estimulo_psychopy_Builder-master\\Estimulo_psychopy_Builder-master\\Estimulo_ICE_lastrun.py',
        ...
        for thisLoop_1 in loop_1:
            ...
            while continueRoutine and routineTimer.getTime() < 0.3:
                ...
                if key_resp_2.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_2.getKeys(keyList=None, ignoreKeys=["escape"], waitRelease=True)
            ...
            while continueRoutine and routineTimer.getTime() < 0.3:
                ...
                if key_resp_3.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_3.getKeys(keyList=['up','right'], ignoreKeys=["escape"], waitRelease=True)
        ...
        for thisLoop_5 in loop_5:
            ...
            while continueRoutine and routineTimer.getTime() < 0.3:
                ...
                if key_resp_4.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_4.getKeys(keyList=['up','right'], ignoreKeys=["escape"], waitRelease=True)
            ...
            while continueRoutine and routineTimer.getTime() < 0.3:
                ...
                if key_resp_5.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_5.getKeys(keyList=['up','right'], ignoreKeys=["escape"], waitRelease=True)
        ...
        for thisLoop_9 in loop_9:
            ...
            while continueRoutine and routineTimer.getTime() < 0.3:
                ...
                if key_resp_6.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_6.getKeys(keyList=['up','right'], ignoreKeys=["escape"], waitRelease=True)
            ...
            while continueRoutine and routineTimer.getTime() < 0.3:
                ...
                if key_resp_7.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_7.getKeys(keyList=['up','right'], ignoreKeys=["escape"], waitRelease=True)
