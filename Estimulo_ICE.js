...
var key_resp_7;
var text_6;
var _intertrial_interval_Clock;
var polygon_5;
var globalClock;
var routineTimer;
...
var frameN;
var continueRoutine;
var salvarMaxDurationReached;
var salvarMaxDuration;
var salvarComponents;
function salvarRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of salvarComponents)
...
function loop_3LoopBegin(loop_3LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_3 of loop_3) {
...
function loop_4LoopBegin(loop_4LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_4 of loop_4) {
...
function loop_5LoopBegin(loop_5LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_5 of loop_5) {
...
function loop_6LoopBegin(loop_6LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_6 of loop_6) {
...
function loop_7LoopBegin(loop_7LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_7 of loop_7) {
...
function loop_8LoopBegin(loop_8LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_8 of loop_8) {
...
function loop_9LoopBegin(loop_9LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_9 of loop_9) {
...
function loop_10LoopBegin(loop_10LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_10 of loop_10) {
...
function loop_11LoopBegin(loop_11LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_11 of loop_11) {
...
function loop_12LoopBegin(loop_12LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_12 of loop_12) {
...
var codigoMaxDurationReached;
var codigoMaxDuration;
var codigoComponents;
function codigoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of codigoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trialRoutineEachFrame() {
  return async function () {
    ...
    if (text.status === PsychoJS.Status.STARTED){ // only update if being drawn
      text.setText(globalClock.getTime(), false);
    }
...
function trial_2RoutineEachFrame() {
  return async function () {
    ...
    if (key_resp_3.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_3.getKeys({keyList: ['up', 'right'], waitRelease: false});
    ...
    if (text_2.status === PsychoJS.Status.STARTED){ // only update if being drawn
      text_2.setText(globalClock.getTime(), false);
    }
...
function trial_3RoutineEachFrame() {
  return async function () {
    ...
    if (key_resp_4.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_4.getKeys({keyList: ['up', 'right'], waitRelease: false});
    ...
    if (text_3.status === PsychoJS.Status.STARTED){ // only update if being drawn
      text_3.setText(globalClock.getTime(), false);
    }
...
function trial_4RoutineEachFrame() {
  return async function () {
    ...
    if (key_resp_5.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_5.getKeys({keyList: ['up', 'right'], waitRelease: false});
    ...
    if (text_4.status === PsychoJS.Status.STARTED){ // only update if being drawn
      text_4.setText(globalClock.getTime(), false);
    }
...
var trial_5MaxDurationReached;
var _key_resp_6_allKeys;
var trial_5MaxDuration;
...
function trial_5RoutineEachFrame() {
  return async function () {
    ...
    if (key_resp_6.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_6.getKeys({keyList: ['up', 'right'], waitRelease: false});
    ...
    if (text_5.status === PsychoJS.Status.STARTED){ // only update if being drawn
      text_5.setText(globalClock.getTime(), false);
    }
...
var trial_6MaxDurationReached;
var _key_resp_7_allKeys;
var trial_6MaxDuration;
var trial_6Components;
function trial_6RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_6Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_6RoutineEachFrame() {
  return async function () {
    ...
    if (key_resp_7.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_7.getKeys({keyList: ['up', 'right'], waitRelease: false});
    ...
    if (text_6.status === PsychoJS.Status.STARTED){ // only update if being drawn
      text_6.setText(globalClock.getTime(), false);
    }
...
var _intertrial_interval_MaxDurationReached;
var _intertrial_interval_MaxDuration;
var _intertrial_interval_Components;
function _intertrial_interval_RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of _intertrial_interval_Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
